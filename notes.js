...
// Calling a function within a class with Javascript
console.log(student.studentInfo())


// Conditionals, Control Flows and swtich staements
...
// instead of writing if else, we can just use switch
...
switch (6) {
    ...
    case 6:
        text = 'Weekend'
        // this stops the case from going to default after the initial case
        // so once it goes through that case, we break out
        break;

    // If it doesn't fit the other cases it will be a weekday
    default:
        text = 'Weekday'
